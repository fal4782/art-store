  ...
  return (
    ...
    >
      ...
      >
        {/* Sidebar Header */}
        <div
          className={`h-22 flex items-center border-b transition-all duration-300 ${isSidebarOpen ? "px-6 gap-4" : "justify-center"}`}
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  boxShadow: isActive
                    ? `0 10px 20px -10px ${theme.colors.primary}50`
                    : "none",
                }}
              >
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header
          className="h-14 border-b bg-white/80 backdrop-blur-md flex items-center px-4 md:hidden shrink-0"
        ...
        >
          ...
          <span
            className="ml-2 font-black text-xl"
            style={{ color: theme.colors.primary }}
          >
            Admin
          </span>
