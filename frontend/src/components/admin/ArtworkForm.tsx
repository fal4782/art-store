...
export default function ArtworkForm({
  ...
  const iconClass =
    "absolute left-4 top-1/2 -translate-y-1/2 text-lg transition-colors duration-300 opacity-40";
    ...
    <form onSubmit={handleSubmit} className="space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-10">
          {/* Images Section */}
          <section
            className="p-8 rounded-4xl border shadow-sm space-y-6"
            style={{
          ...
          >
            <h3
              ...
              style={{ color: theme.colors.primary }}
            >
              <FiImage style={{ color: theme.colors.secondary }} /> Artwork
              Images
            </h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {formData.images.map((url, index) => (
                <div
                  key={index}
                  className="aspect-square rounded-2xl overflow-hidden bg-stone-50 relative group border border-stone-100"
                >
                  <img
                    src={url}
                    alt="Artwork"
            ...
            <div className="relative">
              <FiLink
                ...
                style={{
                  color: theme.colors.primary,
                  opacity: isFocused === "newImageUrl" ? 1 : 0.4,
                }}
              />
              <input
                type="text"
          ...
          {/* Basic Info */}
          <section
            className="p-8 rounded-4xl border shadow-sm space-y-8"
            style={{
              backgroundColor: theme.colors.surface,
              borderColor: `${theme.colors.primary}08`,
            }}
          >
            <h3
              ...
              style={{ color: theme.colors.primary }}
            >
              <FiInfo style={{ color: theme.colors.secondary }} /> Basic
              Information
            </h3>
        ...
        <div className="space-y-10">
          ...
          >
            <h3
              ...
              style={{ color: theme.colors.primary }}
            >
              <FiLayers style={{ color: theme.colors.secondary }} />{" "}
              Organization
            </h3>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <FiLayers
                    ...
                    style={{
                      color: theme.colors.primary,
                      opacity: isFocused === "categoryId" ? 1 : 0.4,
                    }}
                  />
                  <select
                    required
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.map((t) => (
                    <button
                      ...
                      style={{
                        backgroundColor: formData.tags.includes(t.id)
                          ? theme.colors.secondary
                          : "transparent",
                        borderColor: formData.tags.includes(t.id)
                          ? theme.colors.secondary
                          : `${theme.colors.accent}40`,
                        color: formData.tags.includes(t.id)
                          ? "white"
          ...
          >
            <h3
              ...
              style={{ color: theme.colors.primary }}
            >
              <FaIndianRupeeSign style={{ color: theme.colors.secondary }} />{" "}
              Pricing & Logistics
            </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div
                  className="flex gap-2 p-1 rounded-2xl border-2 transition-all"
                  style={{
                ...
                >
                  {["PHYSICAL", "DIGITAL", "BOTH"].map((type) => (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, type: type as ArtworkType })
                      }
                  ...
                  <div className="relative">
                    <FiMaximize
                      ...
                      style={{
                        ...
                        opacity: isFocused === "dimensions" ? 1 : 0.4,
                      }}
                    />
                    <input
                      type="text"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <FiTag
                    ...
                    style={{
                      color: theme.colors.primary,
                      opacity: isFocused === "medium" ? 1 : 0.4,
                    }}
                  />
                  <input
                    type="text"
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  ...
                  style={{
                    backgroundColor: formData.isAvailable
                      ? `${theme.colors.success}15`
                      : `${theme.colors.accent}15`,
                    color: formData.isAvailable
              ...
              >
                <div
                  className={`absolute top-1 w-6 h-6 rounded-full bg-white transition-all shadow-sm ${formData.isAvailable ? "left-7" : "left-1"}`}
                />
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all`}
                  style={{
                    backgroundColor: formData.isFeatured
              ...
              >
                <div
                  className={`absolute top-1 w-6 h-6 rounded-full bg-white transition-all shadow-sm ${formData.isFeatured ? "left-7" : "left-1"}`}
                />
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all`}
                  style={{
                    backgroundColor: formData.isMadeToOrder
                      ? `${theme.colors.info}15`
                      : `${theme.colors.accent}15`,
                    color: formData.isMadeToOrder
                      ? theme.colors.info
                      : `${theme.colors.primary}40`,
                  }}
                >
              ...
              >
                <div
                  className={`absolute top-1 w-6 h-6 rounded-full bg-white transition-all shadow-sm ${formData.isMadeToOrder ? "left-7" : "left-1"}`}
                />
              </div>
            </div>
          </section>
