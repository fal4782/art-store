    ...
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-10 animate-fade-in">
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-xl opacity-60 max-w-2xl mx-auto font-medium">
          Explore our curated categories, from original canvas paintings to
        ...
        {categories.map((category, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end items-start text-white">
              <div className="px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest mb-4 bg-white/20 backdrop-blur-md">
