      ...
      <div className="max-w-4xl space-y-8 animate-fade-in">
        <div>
          ...
          <p className="opacity-60 font-medium">
            Track your past purchases and downloads.
          </p>
        </div>
        <div className="flex flex-col items-center justify-center p-16 rounded-3xl border-2 border-dashed border-stone-200 text-center">
          <div
            className="w-20 h-20 rounded-full bg-stone-50 flex items-center justify-center text-4xl mb-6"
          ...
          <p className="opacity-60 max-w-sm mb-8">
            Looks like you haven't discovered your perfect piece of art yet.
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {order.orderItems.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-center gap-4 p-3 rounded-2xl bg-stone-50/50 hover:bg-stone-50 transition-colors"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-[10px] uppercase font-black tracking-wider opacity-40">
                          <span>
                            {item.quantity} x {formatPrice(item.priceInPaise)}
                          </span>
                          <span>•</span>
