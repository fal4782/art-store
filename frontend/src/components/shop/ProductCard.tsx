...
export default function ProductCard({
  ...
  const imageUrl =
    images[0] || "https://via.placeholder.com/400x500?text=No+Image";
  ...
  return (
    ...
    >
      ...
      <div
        className="relative aspect-4/5 w-full overflow-hidden rounded-xl cursor-pointer"
      ...
      >
        ...
        {artwork.stockQuantity === 0 && (
          <div
            className="absolute top-3 right-3 px-3 py-1 text-white text-xs font-bold uppercase tracking-widest rounded-full"
      ...
      <div className="space-y-1 px-1">
        <div className="flex justify-between items-start gap-4">
          <h3
            className="font-bold text-lg leading-tight line-clamp-2 group-hover:text-amber-700 transition-colors"
            style={{ color: theme.colors.primary }}
          >
            {name}
          </h3>
