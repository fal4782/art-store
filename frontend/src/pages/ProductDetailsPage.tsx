        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 xl:gap-24 items-start">
                ...
                {artwork.images.map((img, idx) => (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow:
                        mainImage === img
                          ? `0 10px 20px -5px ${theme.colors.secondary}40`
                          : "none",
          ...
          <div className="lg:w-[45%] w-full space-y-5 md:space-y-10">
            <div className="space-y-4 md:space-y-6">
              ...
              <h1
                className="text-3xl md:text-5xl lg:text-7xl font-black leading-[0.95] tracking-tighter"
                style={{ color: theme.colors.primary }}
              >
                {artwork.name}
              </h1>
              ...
              <div
                className="flex items-center gap-4 md:gap-8 border-y py-4 md:py-8"
              ...
              >
                ...
                <div className="space-y-0.5 md:space-y-1">
                  {artwork.stockQuantity > 0 ? (
                    <div
                      className="flex items-center gap-2 text-[10px] md:text-[11px] font-black uppercase tracking-widest"
                  ...
                  <p className="text-[10px] md:text-xs font-bold opacity-40">
              ...
              <div className="pt-2 flex flex-row gap-3 md:gap-5">
                ...
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: isInWishlist(artwork.id)
                      ? `${theme.colors.secondary}15`
                      : "transparent",
                    color: isInWishlist(artwork.id)
                      ? theme.colors.error
            ...
            <div className="relative py-8 md:py-10 px-2 md:px-4 group animate-fade-in-up">
              ...
              <div className="relative space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  />
                  <h3
                    className="font-black text-[10px] md:text-xs uppercase tracking-[0.4em]"
                    style={{ color: theme.colors.secondary }}
                  >
                    Artist's Note
                  </h3>
                ...
                <div className="relative px-2">
                  {/* Quote Marks */}
                  <span
                    className="absolute -left-2 md:-left-4 -top-4 md:-top-6 text-5xl md:text-7xl font-serif pointer-events-none opacity-20 select-none"
                    style={{ color: theme.colors.secondary }}
                  >
                    &ldquo;
                  </span>
                  ...
                  <p
                    className="text-xl md:text-2xl font-medium leading-relaxed italic relative z-10"
                    style={{ color: theme.colors.primary }}
                  >
                    {artwork.description ||
                      "Every stroke is a conversation between the soul and the canvas, capturing a moment of pure creative transcendence."}
                  </p>

                  <span
                    className="absolute -right-2 md:-right-4 bottom-0 text-5xl md:text-7xl font-serif pointer-events-none opacity-20 select-none translate-y-4"
                    style={{ color: theme.colors.secondary }}
                  >
                    &rdquo;
                  </span>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6">
              ...
              >
                <span className="block text-[8px] md:text-[10px] font-black uppercase tracking-[0.15em] opacity-30 mb-1 md:mb-2">
                  Dimensions
                </span>
                <span
                  className="text-sm md:text-lg font-bold truncate block"
                  style={{ color: theme.colors.primary }}
                >
                  {artwork.dimensions || "Custom"}
                </span>
              </div>
              <div
                className="p-4 md:p-6 rounded-2xl md:rounded-3xl border transition-all hover:shadow-lg"
            ...
            <div className="space-y-3 md:space-y-4 px-1 md:px-2">
              <span className="block text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] opacity-30">
                Keywords
              </span>
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4 pt-4 md:pt-6 text-center">
              <div className="space-y-1 md:space-y-2 opacity-40 hover:opacity-100 transition-opacity cursor-default">
                ...
                <span className="block text-[7px] md:text-[8px] font-black uppercase tracking-widest">
                  Verified Artist
                </span>
              </div>
              <div className="space-y-1 md:space-y-2 opacity-40 hover:opacity-100 transition-opacity cursor-default">
